...
2. **Opinionated but open** — we teach a proven stack (Next.js + Convex + Bun) and explain *why*, but every concept maps to whatever you're building
3. **Progressive** — start with basics, unlock advanced patterns as they make sense
...
- **[Web Development](stacks/web-nextjs-convex/)** — Next.js + Convex + Vercel (Aaron's stack)
- **[Local / CLI Workflows](stacks/local-python-cli/)** — Python, automation, scripting

More paths welcome as the community grows.
